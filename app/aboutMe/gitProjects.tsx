                ...
                <div className={styles.gitCardContainer}>
                  ...
                  <div className={styles.gitLang}>
                    <span
                      ...
                      style={{ backgroundColor: `${e.languageColor}` }}
                    ></span>
                    <p className={styles.langText}>{e.language}</p>
                  </div>
                </div>
                <p className={styles.gitCommitMessage}>
                  &ldquo;{e.latestCommit.message}&rdquo;
                </p>
              </Card.Body>
              <Card.Footer className={styles.gitFooter}>
                Last Commit: {e.latestCommit.relative_time}
              </Card.Footer>
            </Card>
          </>
        ))}
